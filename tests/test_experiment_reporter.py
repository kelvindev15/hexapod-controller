...
class ExperimentReporterTests(unittest.TestCase):
    def test_reporter_writes_events_and_summary(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            reporter = ExperimentReporter(experiments_dir=tmpdir, enable_mlflow_artifacts=False)
            ...
            reporter.log_event("action_executed", execution_status="failure", error_message="submit failed")
